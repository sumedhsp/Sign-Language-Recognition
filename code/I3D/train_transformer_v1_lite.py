...
from custom_models_v1_lite import SignLanguageRecognitionModelLite, I3DFeatureExtractor  # Ensure your model script is imported
        ...
        for phase in ['train', 'test']:
            ...
            if phase == 'test':
                ...
                #     best_val_score = val_score
                    model_name = f'{save_model}best_model_lite_{steps:06d}.pt'
